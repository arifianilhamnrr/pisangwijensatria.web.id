...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:1.25rem">
  ...
  <div class="card">
    ...
    <div style="display:flex;align-items:center;gap:11px;padding:.65rem 0;border-bottom:1px solid #FAF4E8">
      ...
      <div>
      <div style="font-size:.875rem;font-weight:500"><?= htmlspecialchars($t['nama_produk']??'-') ?></div>
      <div style="font-size:.75rem;color:var(--muda)"><?= $t['tgl_keluar'] ?> · <?= $t['qty_kel'] ?> <?= htmlspecialchars($t['satuan']??'') ?></div>
      </div>
      <div style="margin-left:auto;font-size:.875rem;font-weight:600;color:var(--coklat);white-space:nowrap">
